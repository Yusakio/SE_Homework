...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <title>Background System of RealHome</title>
		...
		<div class="login" style="display: block;">
			...
			<div class="login-center clearfix">
				...
				<div class="login-center-input">
					<input type="text" name="username" id="username" value="" placeholder="Please enter your Username." onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;Please enter your Username.&#39;">
			...
			<div class="login-center clearfix">
				...
				<div class="login-center-input">
					<input type="password" name="password" id="password" value="" placeholder="Please enter your Password." onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;Please enter your Password.&#39;">
			...
			<div class="login-center clearfix">
				...
				<div class="login-center-input">
					<input style="width:50%;" type="text" name="cpacha" id="cpacha" value="" placeholder="Enter Vcode" onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;Enter Vcode&#39;">
					<div class="login-center-input-text">VCode</div>
	...
	function changeCpacha(){
		...
		document.querySelector(".login-button").onclick = function(){
				...
				if(cpacha == '' || cpacha == 'undefined'){
					alert("Please enter verified code.");
					return;
				}
